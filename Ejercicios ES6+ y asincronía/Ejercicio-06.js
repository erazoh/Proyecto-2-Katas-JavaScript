...
const suma = exams.reduce((nota, score) => nota+score.score,0);
...
const sumaAprobados = exams.reduce((nota,score)=>{if(score.score>=5){return nota+score.score}return nota},0)
console.log(sumaAprobados)

// 6.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().

const media = exams.reduce((nota, score) => nota+score.score,0)/exams.length;
console.log(media)