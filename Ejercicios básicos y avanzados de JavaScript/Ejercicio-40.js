...
console.log(`el personaje que esta buscando se encuntra en la posicion ${findArrayIndex(mainCharacters,"Rey")}`)
...
console.log(`La nueva lista con el personaje eliminado:
